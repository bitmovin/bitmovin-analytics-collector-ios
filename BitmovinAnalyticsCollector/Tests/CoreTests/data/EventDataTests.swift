...
class EventDataTests: XCTestCase {
    ...
    func testSerializesCorrectly() throws {
        ...
        eventData.deviceInformation = DeviceInformationDto(manufacturer: "Apple", model: "iPhone", isTV: false, operatingSystem: "iOS", operatingSystemMajorVersion: "15", operatingSystemMinorVersion: "2", deviceClass: DeviceClass.Phone)
