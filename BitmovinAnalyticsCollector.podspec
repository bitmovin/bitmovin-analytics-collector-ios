...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BitmovinAnalyticsCollector.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Cory Zachman/BitmovinAnalyticsCollector'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Cory Zachman' => 'cory.zachman@bitmovin.com' }
  s.source           = { :git => 'https://github.com/Cory Zachman/BitmovinAnalyticsCollector.git', :tag => s.version.to_s }
