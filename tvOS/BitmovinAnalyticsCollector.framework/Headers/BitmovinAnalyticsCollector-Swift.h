...
SWIFT_CLASS("_TtC26BitmovinAnalyticsCollector17AVPlayerCollector")
@interface AVPlayerCollector : BitmovinAnalyticsInternal
@end
...
- (void)onAdManifestLoaded:(BMPAdManifestLoadedEvent * _Nonnull)event;
...
- (void)onAdClicked:(BMPAdClickedEvent * _Nonnull)event;
- (void)onAdSkipped:(BMPAdSkippedEvent * _Nonnull)event;
- (void)onAdError:(BMPAdErrorEvent * _Nonnull)event;
- (void)onAdQuartile:(BMPAdQuartileEvent * _Nonnull)event;
@end

@class BitmovinAnalyticsConfig;
@class BMPBitmovinPlayer;

SWIFT_CLASS("_TtC26BitmovinAnalyticsCollector23BitmovinPlayerCollector")
@interface BitmovinPlayerCollector : BitmovinAnalyticsInternal
...
- (void)attachPlayerWithPlayer:(BMPBitmovinPlayer * _Nonnull)player;
@end
...
/// Attach a player instance to this analytics plugin. After this is completed, BitmovinAnalytics
/// will start monitoring and sending analytics data based on the attached player instance.
- (void)attachBitmovinPlayerWithPlayer:(BMPBitmovinPlayer * _Nonnull)player;
@end
