...
public class StateMachine {
    ...
    // play attempt
    public private(set) var didAttemptPlayingVideo = false
    public private(set) var didStartPlayingVideo = false
    ...
    public func onPlayAttemptFailed(
    ...
    func enableHeartbeat() {
        ...
        heartbeatTimer = Timer.scheduledTimer(
            ...
            target: self,
            selector: #selector(StateMachine.onHeartbeat),
            userInfo: nil,
            repeats: true
        )
    }
