...
pod 'BitmovinAnalyticsCollector/Core', '1.24.2'
pod 'BitmovinAnalyticsCollector/BitmovinPlayer', '1.24.2'
...
source 'https://github.com/bitmovin/cocoapod-specs.git'
pod 'BitmovinAnalyticsCollector/Core', '1.24.2'
pod 'BitmovinAnalyticsCollector/AVPlayer', '1.24.2'
...
```ruby
source 'https://github.com/bitmovin/cocoapod-specs.git'
pod 'BitmovinAnalyticsCollector', '1.24.2'
pod 'BitmovinPlayer', '2.51.0'
