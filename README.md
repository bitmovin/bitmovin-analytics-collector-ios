...
```ruby
  ...
  pod 'BitmovinAnalyticsCollector/Core', '1.20.0'
  pod 'BitmovinAnalyticsCollector/BitmovinPlayer', '1.20.0'
...
```ruby
  source 'https://github.com/bitmovin/cocoapod-specs.git'
  pod 'BitmovinAnalyticsCollector/Core', '1.20.0'
  pod 'BitmovinAnalyticsCollector/AVPlayer', '1.20.0'
...
```ruby
  source 'https://github.com/bitmovin/cocoapod-specs.git'
  pod 'BitmovinAnalyticsCollector', '1.20.0'
  pod 'BitmovinPlayer', '2.51.0'
