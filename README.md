...
pod 'BitmovinAnalyticsCollector/Core', '1.29.1'
pod 'BitmovinAnalyticsCollector/BitmovinPlayer', '1.29.1'
...
```ruby
source 'https://github.com/bitmovin/cocoapod-specs.git'
pod 'BitmovinAnalyticsCollector/Core', '2.9.1'
pod 'BitmovinAnalyticsCollector/BitmovinPlayer', '2.9.1'
...
source 'https://github.com/bitmovin/cocoapod-specs.git'
pod 'BitmovinAnalyticsCollector/Core', '2.9.1'
pod 'BitmovinAnalyticsCollector/AVPlayer', '2.9.1'
...
```ruby
source 'https://github.com/bitmovin/cocoapod-specs.git'
pod 'BitmovinAnalyticsCollector', '1.29.1'
pod 'BitmovinPlayer', '2.51.0'
